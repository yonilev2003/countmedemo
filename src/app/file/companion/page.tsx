...
function useHebrewSpeech() {
  ...
  function speak(text: string) {
    ...
    utter.rate = 0.95;
    utter.pitch = 1.05;
    // Prefer a Hebrew voice if the OS has one (Carmit on macOS, etc.)
...
export default function CompanionPage() {
  ...
  // Stop narration whenever the user navigates between steps
  useEffect(() => {
  ...
  return (
    <div className="min-h-screen bg-cream flex flex-col">
      ...
      <main className="flex-1 mx-auto w-full max-w-screen-sm px-4 py-5 space-y-4">
        ...
        {/* Screenshot frame with overlaid Eitan pointer */}
