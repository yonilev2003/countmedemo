...
- **`memory/risk-gap.md` נוצר** — מפת שבריריות המנוע (false positives), מבוססת סריקה מרובת-סוכנים על הקוד
  עם אימות אדוורסרי לכל ממצא (‏7 תחומים: קבועים, מחשבונים, intake, תצוגת-confidence, upload, צ'אט, טסטים).
