...
## סבב 03/07/2026 — סשן-צד: אימות כל קבועי 2025/2026 מול האינטרנט (ענף `claude/tax-rules-version-hvnzt3`)

- **מה נעשה:** 3 workflows אדוורסריים (9 נושאי מס × חוקר+מפריך · 4 עדשות סתירות · 4 נושאי ב"ל/הוני
  שיוני העלה) — ~640 חיפושי אינטרנט, כל ערך קיבל ציון סבירות נפרד לכל שנה.
- **תוקן (2 commits, push):** ב"ל 7.70%/18.00% · 6111→254,237 (2025/2026) · תקרה מוטבת 20,520/2025 ·
  +2% מס יסף הוני (קבוע, לא מחווט) · תיקון 265 (לא 257) · מדרגת 20-יום מילואים=2028 (היה 2027 גם
  ב-UI!) · בלוק golden-tests להפרדת שנים · 5 סתירות-הערות. **אפס שינוי במספרי הדמו של דנה.**
- **נחקר בלי לקודד:** שדה 032 נאסף-ולא-ממוסה (צריך מחשבון §125ב/ג flat-rate נפרד — אסור לערבב במדרגות) ·
  תוספת 25% לעצמאי במילואים אמיתית אך תלוית-הגדרת-ב"ל שהסכימה לא מכסה · תוספת 40% = סוף-צו, לא מיידית ·
  clawback לעצמאים (דוח מבקר 11/2025). הכל ב-STATUS.
- **מה לא עבד / לקחים:** פרוקסי חוסם gov.il/btl ישירות (403) → סבירות 90-94% במקום 98% לחלק מהערכים.
  Gemini בשיחה מקבילה פיברק "יכולות שנוספו לקוד" — אומת שאין כאלה; לתעד ולא לסמוך על פלט ללא כלים.
- **סטטוס:** הענף מחכה להחלטת PR של יוני. בטסטים: 101/101 · tsc נקי · build ירוק.
