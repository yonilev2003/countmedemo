...
3. **פערי דומיין שהעלה יוני (WS3 מתחיל להיפתח):**
   (א) הכנסות שאינן מיגיעה אישית — הסכימה מציגה שדות (ריבית/דיבידנד/שכ"ד/רווח הון, schema.ts:386-501)
   אבל **הוויזרד לא שואל עליהן** (step 4 = מחזור עסקי בלבד; רק field-032 מחושב). פער intake, לא סכימה.
